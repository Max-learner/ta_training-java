...
public class Runner {
    static List<Plane> availablePlanes = Arrays.asList(
    ...
    public static void main(String[] args) {
        Airport airport = new Airport(availablePlanes);
        ...
        System.out.println("Experimental planes: " + airport.getExperimentalPlanes());
        System.out.println("Military planes: " + militaryAirport.getMilitaryPlanes());
        System.out.println("Military fighter planes: " + militaryAirport.getFighterMilitaryPlanes());
        System.out.println("Military bomber planes: " + militaryAirport.getBomberMilitaryPlanes());
        System.out.println("Military transport planes: " + militaryAirport.getTransportMilitaryPlanes());
    }
}
